...
Notice in red output on the terminal that clients might make make mistakes when running SQL queries but should succeed in collecting data on their own:
